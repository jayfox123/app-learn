...
class ModulePage extends StatefulWidget {
  String idSemestre;
  String nameSemestre;
  ModulePage(this.idSemestre, this.nameSemestre);
  @override
  _ModulePageState createState() =>
      _ModulePageState(this.idSemestre, this.nameSemestre);
}
...
class _ModulePageState extends State<ModulePage> {
  ...
  void initState() {
    ...
    SemRef =
        FirebaseDatabase.instance.reference().child('Module').child(idSemestre);
